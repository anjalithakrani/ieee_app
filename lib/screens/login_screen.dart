...
import 'package:campus_app/screens/register_screen.dart';
...
class _LoginScreenState extends State<LoginScreen>
  ...
  void _continueAsGuest() {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (_) => HomeScreen(isGuest: true)),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppHeader(title: "IEEE VESIT"), // Added the AppHeader
